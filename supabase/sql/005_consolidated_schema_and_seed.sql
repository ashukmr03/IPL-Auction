-- Consolidated migration: Creates all required tables and seeds 160 players
-- Run this AFTER 001_core_schema_and_seed.sql (which creates the franchises table)
-- This is safer than running 003 + 004 separately
